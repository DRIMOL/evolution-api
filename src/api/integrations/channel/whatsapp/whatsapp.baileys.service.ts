      ...
      try {
        for (const received of messages) {
          ...
          if (received.message?.pollUpdateMessage) {
            ...
            try {
              ...
              if (pollCreationMessage && 'message' in pollCreationMessage && pollCreationMessage.message?.pollCreationMessage) {
                 ...
                 const payload = {
                   ...
                   pollUpdate: received.message.pollUpdateMessage // A atualização bruta recebida
                 };
            ...
            // Opcional: Se a mensagem for APENAS uma atualização de enquete, você pode querer pular o resto do processamento.
            // continue; 
          }
          // --- FIM: Adição para Tratamento de Atualização de Enquete ---
